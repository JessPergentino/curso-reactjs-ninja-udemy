...
it('map([4,6], (item) => item + 1) should be return [5,7]', () => {
...
it('map([1,2], "func") should throw a TypeError', () => {
    let err
    try {
        map([1, 2], "func")
    } catch (error) {
...
it('map([1,2]) should throw a TypeError with message "The second parameter must be a function"', () => {
    let err
    try {
        map([1, 2], "func")
    } catch (error) {
